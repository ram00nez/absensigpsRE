                    ...
                    <div class="card-body">
                        <div class="presencecontent">
                            ...
                            <div class="presencedetail">
                                ...
                                <h6 class="presencetitle"><span>{{ $absensihariini != null ? $absensihariini->jam_in : 'Belum Absen'}}</span></h6>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="presencecontent">
                            ...
                            <div class="presencedetail">
                                ...
                                <h6 class="presencetitle"><span>{{ $absensihariini != null && $absensihariini->jam_out != null ? $absensihariini->jam_out : 'Belum Absen'}}</span></h6>
                            </div>
                        </div>
                    </div>
                </div>
